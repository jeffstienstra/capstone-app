...
Favorite.create(user_id: 1, park_name: "Acadia National Park", address: "25 Visitor Center Road, Bar Harbor, ME 06409", api_id: "6DA17C86-088E-4B4D-B862-7C1BD5CF236B")
Favorite.create(user_id: 2, park_name: "Yosemite National Park", address: "9039 Village Drive, Yosemite, CA 95389", api_id: "4324B2B4-D1A3-497F-8E6B-27171FAE4DB2")
